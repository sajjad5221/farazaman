          ...
          <div className="container py-20 mx-auto">
            ...
            <div className="grid grid-cols-6 py-20 mx-auto" >
              <div className="max-w-sm col-span-2 mx-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  <a href="#">
                      <img className="rounded-t-lg" src="https://technopolis-rebrand.imgix.net/Technopolis-Events/Zalen/Factory-of-the-future-1.jpg?auto=format&crop=focalpoint&fit=crop&fp-x=0.5&fp-y=0.5&ixlib=php-2.1.1&ratio=1&w=2560&s=05afc004027c729fd7aa354613d3c1cf" alt="" />
                  </a>
                  <div className="p-5">
                      <a href="#">
                          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">رویداد اول</h5>
                      </a>
                  ...
                  و مجله لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت
                  چاپ</p>
                      <a href="#" className="inline-flex px-3 py-2 text-sm font-medium text-center text-white bg-[#EAB308] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                          بیشتر بخوانید
              ...
              <div className="max-w-sm col-span-2 mx-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <div className="p-5">
                      <a href="#">
                          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">رویداد دوم</h5>
                      </a>
                      <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و
                  با و استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه
              ...
              <div className="max-w-sm col-span-2 mx-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <div className="p-5">
                      <a href="#">
                          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">رویداد سوم</h5>
                      </a>
                      <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و
                  با و استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه
