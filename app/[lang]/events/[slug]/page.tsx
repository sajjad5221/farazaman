      ...
      <section className="bg-gray-500 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-center bg-no-repeat bg-blend-multiply">
        <div className="container py-10 mx-auto">
          <div className="grid grid-cols-3">
            <div className="order-2 col-span-3 p-4 m-5 bg-white border border-gray-200 rounded-lg shadow sm:m-16 shrink-0 sm:p-6 lg:mx-10 md:p-8 lg:col-span-1">
      ...
      <div className="bg-gray-50  ">
        <div className="container py-20 mx-auto">
          ...
          <div className="py-3 mx-10">
            <h3 className="text-3xl font-bold text-gray-900">سایر رویدادها</h3>
          </div>
          <hr />
