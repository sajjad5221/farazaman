...
<form className='relative top-[9px] left-[30px] m-[30px] mb-0 mt-[55px] w-full border border-solid border-gray-700 bg-white dark:bg-neutral-900'>
    ...
    <div className="absolute right-[29%] top-[120px] w-[33%] p-[10px] m-0 mr-[69px] ml-[68px] mt-[16px] z-0 mb-6 group s:right-[19%] xl:right-[29%] xl:top-[120px] xl:w-[33%] xl:p-[10px] xl:m-0 xl:mt-[16px] xl:ml-[60px] xl:mr-[55px]  2xl:ml-[69px lg:mr-[55px] lg:right-[29%] md:right-[25%] sm:right-[24%]" id='name-input'>
    ...
    <div className="absolute right-[29%] top-[186px] w-[33%] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] z-0 mb-6 group s:right-[19%] xl:ml-[60px] xl:right-[29%] xl:mr-[55px]  lg:mr-[55px] lg:right-[29%] md:right-[25%] sm:right-[24%]" id='lastName-input'>
    ...
    <div className="absolute right-[29%] top-[258px] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] w-[33%] z-0 mb-6 group s:right-[19%] xl:ml-[60px] xl:right-[29%]  xl:mr-[55px] lg:mr-[55px] lg:right-[29%] md:right-[25%] sm:right-[24%]" id='email-input'>
    ...
    <div className="absolute right-[29%] top-[330px] w-[33%] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] z-0 group s:right-[19%] s:bottom-[450px] xl:ml-[60px] xl:right-[29%]  xl:mr-[55px] lg:mr-[55px] lg:right-[29%] md:right-[25%] sm:right-[24%]" id='phone-input'>
  ...
  <div className='design-type relative right-[28%] bottom-[436px] w-[32%] m-0 mr-[78px] mt-[39px] s:right-[19%] s:bottom-[450px] sm:right-[21%] md:right-[25%] lg:right-[27%] xl:right-[28%]'>
    <p className='description-type w-full text-xl dark:text-gray-400 s:text-[15px] sm:text-lg'>
      نوع طرح :
    </p>
  </div>
  <div className="type1 absolute right-[41%] bottom-[765px] m-[6px] flex items-center mb-4 s:bottom-[756px] s:right-[33%] sm:right-[43%]">
    <input checked id="default-radio-1" type="radio" value="طرح عادی" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 s:w-[15%] sm:w-[14px] sm:-ml-[5px]"/>
    <label htmlFor="default-radio-1" className="mr-[10px] text-[18px] ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 s:text-[14px] sm:text-[16px]">طرح عادی  </label>
  </div>
  <div className="type2 absolute right-[52%] bottom-[775px] m-[6px] flex items-center s:bottom-[765px] s:right-[51%] sm:right-[56%]">
    <input id="default-radio-2" type="radio" value="طرح پویش" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 sm:w-[14px] s:w-[15%] sm:-ml-[5px]"/>
    <label htmlFor="default-radio-2" className="mr-[10px] text-[18px] ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 s:text-[14px] sm:text-[16px]"> طرح پویش </label>
  </div>

  
  <div className="relative right-[29%] bottom-[408px] w-[42%] h-[342px] flex items-center justify-center  s:right-[142px] s:bottom-[433px] sm:right-[197px] md:right-[285px] lg:right-[296px] xl:right-[442px]">
    <p className='description-file absolute -top-[5px] w-[108px] ml-[453px] right-0 m-0 mr-[12%] mt-[22px] text-xl dark:text-gray-400 s:text-[15px] s:-top-[4px] s:right-[0%] s:mr-[30px] s:ml-[67px] sm:-top-[19px] sm:-right-[1px] sm:text-lg sm:mr-[40px] sm:ml-[154px] md:right-0 md:mr-[45px] md:ml-[261px] lg:right-[1px] lg:mr-[120px] lg:ml-[263px] xl:right-[0%] xl:ml-[451px] xl:mr-[67px]'>  اپلود رزومه :</p>
    <label htmlFor="dropzone-file" className="absolute right-[1px] top-[46px] w-[80%] h-[65%] mr-[65px] ml-[64px] my-4 flex flex-col items-center justify-center  border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-600 duration-300 dark:hover:bg-bray-800 dark:bg-gray-700 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 s:right-[4px] s:bottom-[433px] s:mr-[44px] s:ml-[52px] s:w-[109px] s:h-[60%] sm:h-44 sm:right-[0px] sm:mr-[54px] sm:ml-[60px] sm:w-[80%] md:ml-[84px] md:mr-[51px] md:w-[80%] lg:ml-[88px] lg:mr-[117px] lg:w-[80%] lg:h-[60%] xl:right-[0%] xl:ml-[63px] xl:w-[80%] xl:h-[60%] xl:mr-[65px]">
