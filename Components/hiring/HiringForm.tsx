  ...
  useEffect(() => {
    ...
    return (
      <form onSubmit={handleSubmit} className='relative top-[9px] left-[30px] h-[1060px] m-[30px] mb-0 mt-[55px] w-full border-none bg-white dark:bg-neutral-900 2xl:h-[1060px] xl:h-[1060px] lg:h-[1060px] md:h-[1060px] sm:h-[1060px] s:h-[1450px] mobile:h-[1492px]'>
        <div className='box relative m-0 mt-[55px] w-[42%] h-[800px] right-[800px] top-[100px] border-[1px] border-solid border-gray-500 rounded-md shadow shadow-slate-800 dark:shadow-slate-100 xl:right-[667px] 2xl:right-[800px] lg:right-[530px] md:right-[400px] sm:right-[305px] s:right-[142px] mobile:right-[125px]'></div>
        <div className="absolute right-[53%] top-[120px] w-[33%] p-[10px] m-0 mr-[69px] ml-[68px] mt-[16px] z-0 mb-6 group mobile:right-[18%] s:right-[19%]  xl:top-[120px] xl:w-[33%] xl:p-[10px] xl:m-0 xl:mt-[16px] xl:ml-[60px] xl:mr-[55px]  2xl:ml-[69px] 2xl:right-[53%] lg:mr-[55px] lg:right-[51%] md:right-[47%] md:h-[62px] sm:right-[41%] xl:right-[653px]" id='name-input'>
        ...
        <div className="absolute right-[53%] top-[186px] w-[33%] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] z-0 mb-6 group mobile:right-[18%] s:right-[19%] xl:ml-[60px] xl:right-[51%] xl:mr-[55px] 2xl:right-[53%] lg:mr-[55px] lg:right-[51%] md:right-[47%] md:h-[62px] sm:right-[41%]" id='lastName-input'>
        ...
        <div className="absolute right-[53%] top-[258px] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] w-[33%] z-0 mb-6 group mobile:right-[18%] s:right-[19%] xl:ml-[60px] xl:right-[51%]  xl:mr-[55px] 2xl:right-[53%] lg:mr-[55px] lg:right-[51%] md:right-[47%] md:h-[62px] sm:right-[41%]" id='email-input'>
        ...
        <div className="absolute right-[53%] top-[330px] w-[33%] h-[63px] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] z-0 group mobile:right-[18%] s:right-[19%] s:bottom-[450px] xl:ml-[60px] xl:right-[51%]  xl:mr-[55px] 2xl:right-[53%] lg:mr-[55px] lg:right-[51%] md:right-[47%] md:h-[62px] sm:right-[41%]" id='phone-input'>
        ...
        <div className='design-type relative right-[52%] bottom-[420px] w-[32%] m-0 mr-[78px] mt-[39px] mobile:right-[18%] mobile:bottom-[425px] s:right-[19%] s:bottom-[420px] sm:right-[41%] sm:bottom-[427px] md:right-[47%] md:bottom-[420px] lg:right-[50%] lg:bottom-[420px] xl:right-[50%] xl:bottom-[420px] 2xl:right-[52%]'>
          <p className='description-type text-zinc-600 w-full text-xl dark:text-gray-400 mobile:text-[15px] s:text-[15px] sm:text-lg'>
            نوع طرح :
          </p>
        </div>
        <div className="type1 absolute right-[66%] bottom-[600px] m-[6px] flex items-center mb-4 mobile:right-[35%] mobile:bottom-[1008px] s:bottom-[960px] s:right-[33%] sm:right-[57%] sm:bottom-[575px] md:right-[66%] md:bottom-[600px] lg:right-[68%] lg:bottom-[600px] xl:right-[63%] xl:bottom-[600px] 2xl:right-[66%]">
        ...
        <div className="type2 absolute right-[77%] bottom-[610px] w-[7%] m-[6px] flex items-center mobile:right-[35%] mobile:bottom-[980px] mobile:w-[22%] s:bottom-[970px] s:right-[51%] s:w-[18%] sm:right-[57%] sm:bottom-[555px] sm:w-[15%] md:right-[77%] md:bottom-[610px] md:w-[12%] lg:right-[78%] lg:bottom-[610px] lg:w-[9%] xl:right-[77%] xl:bottom-[610px] xl:w-[10%] 2xl:right-[77%]">
        ...
        <div className="relative right-[800px] bottom-[408px] w-[42%] h-[342px] flex items-center justify-center mobile:right-[30%] s:right-[145px] s:bottom-[433px] sm:right-[305px] md:right-[400px] lg:right-[530px] xl:right-[654px] 2xl:right-[800px]">
          <p className='description-file absolute text-zinc-600 top-[25px] w-[108px] right-0 m-0  ml-[464px]  mr-[68px] mt-[22px] text-xl dark:text-gray-400 mobile:text-[15px] mobile:top-[30px] mobile:right-[0%] mobile:mr-[25px] mobile:ml-[43px] s:text-[15px] s:top-[35px] s:right-[0%] s:mr-[30px] s:ml-[67px] sm:top-[55px] sm:-right-[1px] sm:text-lg sm:mr-[33px] sm:ml-[129px] md:right-0 md:mr-[44px] md:ml-[169px] md:top-[25px] lg:right-[1px] lg:top-[25px] lg:mr-[55px] lg:ml-[265px] xl:right-[0%] xl:top-[25px] xl:ml-[366px] xl:mr-[63px] 2xl:mr-[70px] 2xl:ml-[462px]'>  اپلود رزومه :</p>
        ...
        <button type="submit" className="absolute right-[53%] top-[818px] mr-[268px] ml-[268px] mt-[36px] my-[25px] mx-[279px] text-yellow-700 bg-zinc-400 hover:bg-yellow-700 hover:text-zinc-300 duration-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-zinc-400 dark:text-yellow-700 dark:hover:text-zinc-200 dark:hover:bg-yellow-700 dark:focus:ring-yellow-700 mobile:right-[29%] mobile:top-[54%] mobile:w-[24%] mobile:mr-[36px] mobile:ml-[38px] s:right-[144px] s:top-[781px] s:w-[20%] s:mr-[52px] s:ml-[56px] sm:top-[762px] sm:right-[50%] sm:ml-[86px] sm:mr-[73px] md:right-[52%] md:mr-[115px] md:ml-[129px] lg:right-[51%] lg:w-[9%] lg:mr-[170px] lg:ml-[175px] xl:right-[51%] xl:mr-[230px] xl:ml-[224px] 2xl:right-[56%]">ثبت فرم </button>
        <div className="contact-box relative bottom-[919px] right-0 mr-[140px] p-3 flex w-[35%] h-[280px] 2xl:bottom-[1063px] 2xl:-right-[80px] xl:h-[320px] xl:bottom-[1063px] xl:-right-[80px]  lg:h-[340px] lg:bottom-[1063px] lg:-right-[100px] md:h-[390px] md:bottom-[1063px] md:-right-[130px] sm:h-[430px] sm:bottom-[1063px] sm:-right-[128px] s:bottom-[278px] s:h-[480px] s:w-[44%] s:-right-[7px] mobile:bottom-[220px] mobile:w-[51%] mobile:-right-[10%] mobile:h-[500px]">
