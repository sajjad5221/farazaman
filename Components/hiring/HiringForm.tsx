...
const HiringForm = () => {
  ...
  useEffect(() => {
    ...
    <div className="bg-gray-50 dark:bg-neutral-900 mt-16" id="contact">
      <form onSubmit={handleSubmit} className='relative top-[9px] left-[30px] m-[30px] mb-0 mt-[55px] w-full border border-solid border-gray-700 bg-white dark:bg-neutral-900'>
