  ...
  useEffect(() => {
    ...
    return (
      <form onSubmit={handleSubmit} className='relative top-[9px] left-[30px] h-[1060px] m-[30px] mb-0 mt-[55px] w-full border-none bg-white dark:bg-neutral-900 2xl:h-[1060px] xl:h-[1060px] lg:h-[1060px] md:h-[1060px] sm:h-[1060px] s:h-[1450px] mobile:h-[1492px] little:h-[1387px]'>
        ...
        <div className="absolute right-[53%] top-[120px] w-[33%] p-[10px] m-0 mr-[69px] ml-[68px] mt-[16px] z-0 mb-6 group mobile:-right-[20px] mobile:w-[77%] s:-right-[3%] s:w-[77%] xl:w-[33%] xl:top-[137px] xl:right-[52%] xl:p-[10px] xl:m-0 xl:mt-[16px] xl:ml-[60px] xl:mr-[55px] 2xl:w-[33%]  2xl:ml-[69px] 2xl:right-[53%] 2xl:top-[162px] lg:w-[33%] lg:mr-[55px] lg:right-[49%] lg:top-[137px] md:w-[33%] md:right-[50%] md:top-[137px] md:h-[62px] sm:w-[33%] sm:right-[41%] sm:top-[137px] s:top-[164px] mobile:top-[164px] little:w-[75%] little:-right-[7%] little:top-[164px] long:right-[45%] long2:right-[41%] long3:right-[39%] long4:right-[46%] long5:right-[35%]" id='name-input'>
        ...
        <div className="absolute right-[53%] top-[186px] w-[33%] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] z-0 mb-6 group mobile:-right-[20px] mobile:w-[77%] s:-right-[3%] s:w-[77%] xl:w-[33%] xl:ml-[60px] xl:right-[52%] xl:top-[205px] xl:mr-[55px] 2xl:w-[33%] 2xl:right-[53%] 2xl:top-[232px] lg:mr-[55px] lg:w-[33%] lg:right-[49%] lg:top-[205px] md:w-[33%] md:right-[50%] md:top-[205px] md:h-[62px] sm:w-[33%] sm:right-[41%] sm:top-[205px] s:top-[232px] mobile:top-[232px] little:w-[75%] little:-right-[7%] little:top-[232px] long:right-[45%] long2:right-[41%] long3:right-[39%] long4:right-[46%] long5:right-[35%]" id='lastName-input '>
        ...
        <div className="absolute right-[53%] top-[258px] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] w-[33%] z-0 mb-6 group mobile:-right-[20px] mobile:w-[77%] s:-right-[3%] s:w-[77%] xl:w-[33%] xl:ml-[60px] xl:right-[52%] xl:top-[280px]  xl:mr-[55px] 2xl:w-[33%] 2xl:right-[53%] 2xl:top-[307px] lg:w-[33%] lg:mr-[55px] lg:right-[49%] lg:top-[280px] md:w-[33%] md:right-[50%] md:top-[280px] md:h-[62px] sm:w-[33%] sm:right-[41%] sm:top-[280px] s:top-[305px] mobile:top-[305px] little:w-[75%] little:-right-[7%] little:top-[305px] long:right-[45%] long2:right-[41%] long3:right-[39%] long4:right-[46%] long5:right-[35%]" id='email-input '>
        ...
        <div className="absolute right-[53%] top-[330px] w-[33%] h-[63px] p-[10px] m-0 mr-[69px] ml-[68px] mt-[22px] z-0 group mobile:-right-[20px] mobile:w-[77%] s:-right-[3%] s:w-[77%] s:bottom-[450px] xl:w-[33%] xl:ml-[60px] xl:right-[52%] xl:top-[355px]  xl:mr-[55px] 2xl:w-[33%] 2xl:right-[53%] 2xl:top-[382px] lg:w-[33%] lg:mr-[55px] lg:right-[49%] lg:top-[355px] md:w-[33%] md:right-[50%] md:top-[355px] md:h-[62px] sm:w-[33%] sm:right-[41%] sm:top-[354px] s:top-[378px] mobile:top-[379px] little:w-[75%] little:-right-[7%] little:top-[379px] long:right-[45%] long2:right-[41%] long3:right-[39%] long4:right-[46%] long5:right-[35%]" id='phone-input '>
        ...
        <div className='design-type relative right-[52%] bottom-[420px] w-[32%] m-0 mr-[78px] mt-[39px] mobile:w-[70%] mobile:-right-[15px] mobile:bottom-[567px] mobile2:bottom-[540px] s:-right-[3%] s:bottom-[529px] sm:w-[30%] sm:right-[41%] sm:bottom-[565px] md:w-[31%] md:right-[50%] md:-top-[545px] lg:w-[31%] lg:right-[50%] lg:bottom-[540px] xl:w-[31%] xl:right-[51%] xl:bottom-[540px] 2xl:right-[53%] 2xl:-top-[533px] little:w-[20%] little:-right-[7%] little:bottom-[567px] little2:bottom-[540px] long:right-[44%] long2:right-[40%] long3:right-[39%] long4:right-[46%]'>
          <p className='description-type text-zinc-600 w-full text-xl dark:text-gray-400 mobile:text-[18px] s:text-[18px] sm:text-lg'>
            نوع طرح :
          </p>
        </div>
        <div className="type1 absolute right-[66%] bottom-[600px] m-[6px] flex items-center mb-4 mobile:right-[35%] mobile:bottom-[984px] s:bottom-[930px] s:right-[33%] sm:right-[57%] sm:bottom-[545px] md:right-[70%] md:bottom-[558px] lg:right-[68%] lg:bottom-[550px] xl:right-[66%] xl:bottom-[552px] 2xl:right-[66%] 2xl:bottom-[545px] little:right-[40%] little:bottom-[878px] long:right-[59%] long:bottom-[557px] long2:right-[56%] long2:bottom-[557px] long3:right-[58%] long4:right-[66%]">
        ...
        <div className="type2 absolute right-[77%] bottom-[610px] w-[7%] m-[6px] flex items-center mobile:right-[61%] mobile:bottom-[993px] mobile:w-[22%] s:bottom-[940px] s:right-[60%] s:w-[20%] sm:right-[57%] sm:bottom-[525px] sm:w-[15%] md:right-[82%] md:bottom-[568px] md:w-[12%] lg:right-[78%] lg:bottom-[560px] lg:w-[9%] xl:right-[77%] xl:bottom-[562px] xl:w-[8%] 2xl:right-[77%] 2xl:bottom-[555px] 2xl:w-[90px] little:right-[68%] little:bottom-[888px] little:w-[26%] long:right-[72%] long:bottom-[567px] long2:right-[68%] long2:bottom-[567px] long3:right-[70%] long4:right-[78%]">
        ...
        <input type="submit" value="ثبت فرم" className="absolute right-[53%] top-[818px] mr-[268px] ml-[268px] mt-[36px] my-[25px] mx-[279px] cursor-pointer text-yellow-700 bg-zinc-400 hover:bg-yellow-700 hover:text-zinc-300 duration-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-zinc-400 dark:text-yellow-700 dark:hover:text-zinc-200 dark:hover:bg-yellow-700 dark:focus:ring-yellow-700 mobile:right-[29%] mobile:top-[56%] mobile:w-[24%] mobile:mr-[36px] mobile:ml-[38px] mobile2:top-[55%] s:right-[29%] s:top-[800px] s:w-[20%] s:mr-[52px] s:ml-[56px] sm:top-[800px] sm:right-[50%] sm:ml-[86px] sm:mr-[73px] md:right-[55%] md:top-[771px] md:mr-[115px] md:ml-[129px] lg:right-[51%] lg:top-[810px] lg:w-[9%] lg:mr-[170px] lg:ml-[175px] xl:right-[51%] xl:mr-[230px] xl:ml-[224px] xl:top-[818px] 2xl:right-[54%] 2xl:top-[815px] little:-right-[38%] little:top-[842px] little:w-[25%] little2:top-[815px] little2:-right-[36%] long:right-[46%] long2:right-[44%] long3:right-[46%] long4:right-[51%]"/>
        <div className="contact-box relative bottom-[919px] right-0 mr-[140px] p-3 flex w-[35%] h-[280px] 2xl:mr-[140px] 2xl:bottom-[1210px] 2xl:right-0 2xl:w-[35%] xl:mr-[140px] xl:h-[320px] xl:bottom-[1213px] xl:-right-[30px] xl:w-[35%] lg:mr-[140px] lg:h-[340px] lg:bottom-[1213px] lg:-right-[60px] lg:w-[35%] md:mr-[140px] md:h-[390px] md:bottom-[1213px] md:-right-[65px] md:w-[35%] sm:mr-[140px] sm:h-[430px] sm:bottom-[1213px] sm:-right-[115px] sm:w-[35%] s:bottom-[390px] s:h-[430px] s:w-full s:right-0 mobile:bottom-[400px] mobile:w-full mobile:right-0 mobile:h-[420px] little:right-0 little:bottom-[410px] little:mr-0 little:w-full little:h-[380px] long3:-right-[100px] long2:-right-[100px]">
