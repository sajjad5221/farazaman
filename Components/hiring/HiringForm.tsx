  ...
  useEffect(() => {
    ...
    return (
      <form onSubmit={handleSubmit} className='relative top-[9px] left-[30px] h-[1060px] m-[30px] mb-0 mt-[55px] w-full border-none bg-white dark:bg-neutral-900 2xl:h-[1060px] xl:h-[1060px] lg:h-[1060px] md:h-[1060px] sm:h-[1060px] s:h-[1450px] mobile:h-[1492px]'>
        <div className='box relative m-0 mt-[55px] w-full h-[800px] right-[0px] top-[100px] border-[1px] border-solid border-gray-500 rounded-md shadow shadow-slate-800 dark:shadow-slate-100 xl:w-[42%] xl:right-[667px] 2xl:w-[42%] 2xl:right-[53%] lg:w-[42%] lg:right-[530px] md:w-[42%] md:right-[400px] sm:w-[42%] sm:right-[305px] s:right-0 s:w-full mobile:right-0 mobile:w-full'></div>
