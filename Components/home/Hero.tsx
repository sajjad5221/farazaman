    ...
    <div className="bg-gray-50 px-4 sm:px-6 lg:px-8 pt-16">
      <div className="max-w-7xl mx-auto py-8 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="pt-6 md:pt-32 justify-center text-center sm:justify-start sm:text-start">
          ...
          <p className="pt-6 text-base text-zinc-600 w-auto sm:w-10/12 md:w-10/12  ">
          ...
          <div className="flex justify-center mt-3  sm:w-10/12 md:w-10/12">
            <Link
              href="/hiring"
              className="text-white flex justify-center basis-1/2	rounded px-5 py-2 text-base font-medium text-center bg-yellow-500 border border-yellow-500 focus:outline-none hover:bg-yellow-600 focus:ring-4 focus:ring-yellow-700  mr-2 mb-2"
            >
